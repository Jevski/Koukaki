...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="story" class="story">
            <div class = "titleHistoire">
                <img class ="sunflowerHistoire" src=<?php echo get_stylesheet_directory_uri(). "/assets/images/Sunflower.png" ?> >

            <h2> <span class="sectionTitles ">L'</span>
                 <span class ="sectionTitles">histoire</span> 
            </h2>
                <img class= "hibiscusHistoire" src=<?php echo get_stylesheet_directory_uri(). "/assets/images/Hibiscus.png" ?> >
            </div>
